        ...
        {isPro ? (
          <View style={styles.heroPro}>
            ...
            <Text style={styles.heroSubtitle}>
              Thank you for supporting ChefLinks. Manage billing or cancel anytime in your store account.
            </Text>
          ...
          <View style={styles.hero}>
            ...
            <Text style={styles.heroSubtitle}>
              Save every recipe link, organize in collections, and grow your library as much as you want.
            </Text>
          </View>
        )}
        ...
        {!isPro ? (
          <>
            ...
            <Text style={styles.freeFootnote}>
              Free during beta: {PLAN_LIMITS.free.maxWorkouts} recipes and {PLAN_LIMITS.free.maxCollections}{' '}
