      ...
      { text: 'Cancel', style: 'cancel' },
      {
        ...
        onPress: async () => {
          ...
          try {
            ...
            Alert.alert(
              'Delete Failed',
              err?.message ?? 'Could not delete recipe. Please try again.',
            );
          } finally {
            setIsDeleting(false);
          }
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView style={styles.body}>
        ...
        {/* Title & Domain */}
        <Text style={styles.title}>{workout.title || 'Untitled Recipe'}</Text>
        ...
        <View style={styles.actions}>
          <TouchableOpacity style={styles.primaryBtn} onPress={handleOpen}>
            ...
            <Text style={styles.primaryBtnText}>Open Recipe</Text>
          </TouchableOpacity>
