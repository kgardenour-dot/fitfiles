...
export default function SaveScreen() {
  ...
  useEffect(() => {
    fetchTags();
    fetchWorkouts(); // To count recipes for gating
          ...
          <View style={styles.helpCard}>
            ...
            >
              ...
              <Text style={styles.helpBody}>
                ...
                Use Share, then choose ChefLinks. The link is sent into the app so you can confirm details and
                save.
              </Text>
              <Text style={styles.helpSectionLabel}>Don't see ChefLinks in the short list?</Text>
              <Text style={styles.helpBody}>
                Swipe sideways on the row of app icons—ChefLinks is often past the first few. On iPhone or iPad,
                tap Edit or ••• on the share sheet to turn ChefLinks on, or drag it into Favorites so it stays
              ...
              <Text style={[styles.helpBody, styles.helpBodyLast]}>
                If you save a URL you already have, we update that recipe instead of creating a duplicate.
              </Text>
            </ScrollView>
            <TouchableOpacity
